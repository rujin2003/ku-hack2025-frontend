  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "neon-subtle": "0 0 10px hsl(var(--primary) / 0.3), 0 0 30px hsl(var(--primary) / 0.15)",
        "glass": "0 0 30px hsl(var(--primary) / 0.1), inset 0 1px 0 hsl(var(--primary) / 0.1)",
      },
    },
  },
